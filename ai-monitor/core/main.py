...
try:
    ...
    import uvicorn
    import httpx
    # import aioredis  # 暂时禁用 - Python 3.13兼容性问题
    # import asyncpg   # 暂时禁用 - Python 3.13兼容性问题
...
class AIMonitorCore:
    ...
    def __init__(self):
        ...
        self.redis_client = None  # Optional[aioredis.Redis] = None - 暂时禁用
        self.db_pool = None       # Optional[asyncpg.Pool] = None - 暂时禁用
